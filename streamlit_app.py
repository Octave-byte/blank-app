...
# Allowed chains
CHAIN_OPTIONS = ["Gnosis","Ethereum", "Solana","Abstract", "Sui", "Base", "Arbitrum", "Polygon", "Berachain", "Optimism", "Lisk", "Taiko", "Rootstock", "Sonic", "Soneium", "Bitcoin", "Avalanche", "BSC", "HyperEVM", "Corn", "Ink","Superposition"]
